...
document.write('			 </div>');
document.write('			 <div id="intro_text_div">I am an associate research scientist, principal investigator and lecturer at the Computer Science dept., UCSB. My research background is in AI, with focus on recommender systems.  I have a particular interest in modeling trust in social networks,  both at the data-mining layer and visualization-interaction layers. 	 I am also co-founder and CTO of <a href=http://www.sirassystems.com>Siras Systems Inc.</a>, providers of personalized educational planning and reporting.	  ');
